  ...
  ConvergenceTable convergence_table;
    ...
    DiffusionProblem<dim>::make_grid()
    {
      ...
      triangulation.refine_global(n_refine);
         ...
         std::cout <<  " FEM Coarse TRI MEMORY --- "
    ...
    DiffusionProblem<dim>::setup_system()
    {
      ...
      std::cout<<  " FEM Coarse DOF MEMORY --- " << dof_handler.memory_consumption () << std::endl;
    }
    ...
    DiffusionProblem<dim>::solve_iterative()
    {
      ...
      pcout <<  "FEM Coarse Solution MEMORY --- "<<   locally_relevant_solution.memory_consumption()
       	    	          << "  " << std::endl;
    }
...
template <int dim>
void DiffusionProblem<dim>::compute_errors()
{
